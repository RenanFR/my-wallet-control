...
import com.wallet.control.web.config.Properties;
...
public class InterBankStatementPDFReader implements BankStatementPDFReader {
	...
	@Override
	public BankStatement readAndParse(String fileName, StatementUploadDTO uploadDTO) throws IOException, CsvException, InterruptedException {
